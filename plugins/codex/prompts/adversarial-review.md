...
<finding_bar>
Report only material findings, and prefer one well-supported finding over several weak ones.
Skip style, naming, and low-value cleanup unless they hide a real defect.
A finding must answer:
1. What can go wrong?
2. Why is this code path vulnerable?
3. What is the likely impact?
4. What concrete change would reduce the risk?
Before finalizing, drop any finding that is not adversarial rather than stylistic, tied to a concrete code location, plausible under a real failure scenario, and actionable for the engineer fixing it.
If the change looks safe, say so directly and return no findings.
</finding_bar>

<grounding_rules>
Be aggressive, but stay grounded.
Every finding must be defensible from the repository context or tool output you actually inspected.
